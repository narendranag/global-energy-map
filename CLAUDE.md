...
│   └── e2e/                       # 18 Playwright specs (map, layers, time, scenarios, modes, url, share, data, methodology, query, legal, network, errors, phone, a11y, focus, country-panel, embed) + helpers.ts
├── docs/
