 ...
 * table lives on /about.
 */
export function MapFooter() {
  return (
    <div className="pointer-events-auto absolute bottom-2 left-4 z-10 max-w-60 rounded bg-white/85 px-2 py-1 text-[10px] leading-snug text-slate-700 shadow-sm backdrop-blur">
