...
const lngImports: LngImportRow[] = [
  ...
  { asset_id: "KOR-T1", name: "KOR-T1", country_iso3: "KOR", capacity: 100 },
  { asset_id: "GBR-T1", name: "GBR-T1", country_iso3: "GBR", capacity: 100 },
];
...
describe("computeScenarioImpact — hormuz under commodity=gas", () => {
  it("populates byLngImport and leaves byRefinery empty", () => {
    ...
    expect(at(result.rankedLngImports, 0).asset_id).toBe("GBR-T1");
