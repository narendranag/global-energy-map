...
>
> Status: Phases 1–10 shipped (live at https://energymap.marain.space; the old https://global-energy-map-one.vercel.app address permanently redirects there). See `docs/superpowers/specs/2026-05-15-global-energy-map-design.md` for the full design and `docs/superpowers/plans/` for per-phase plans.
