...
>
> Status: Phases 1–9 shipped (live at https://global-energy-map-one.vercel.app). See `docs/superpowers/specs/2026-05-15-global-energy-map-design.md` for the full design and `docs/superpowers/plans/` for per-phase plans.
...
- **Phase 10 — Public-launch hardening** — _in progress_ on branch `phase-10-launch` (plan: `docs/superpowers/plans/2026-09-10-global-energy-map-phase-10.md`): perf + caching + self-hosted DuckDB, LICENSE-DATA.md + open asset extract, refresh runbook, analytics + error boundary + post-deploy smoke.
