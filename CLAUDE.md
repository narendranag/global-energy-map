...
│   └── e2e/                       # 22 Playwright specs (map, layers, time, scenarios, scenario-map, scenario-context, modes, url, share, data, methodology, query, legal, network, errors, phone, a11y, focus, country-panel, embed, search, trade-flows) + helpers.ts
├── docs/
